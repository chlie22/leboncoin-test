...
- Every parameter error is a 400 problem+json with `violations`. Conversion errors (`int1=abc`, arrays) are reported alone, because Symfony skips validation when a conversion fails: documented behaviour, not a bug.
